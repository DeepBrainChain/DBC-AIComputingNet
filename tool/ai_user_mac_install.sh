...
wget https://github.com/DeepBrainChain/deepbrainchain-release/releases/download/0.3.3.1/dbc-macos-client-0.3.3.1.tar.gz
if [ $? -ne 0 ]; then
    echo "***wget DBC release package failed***"
    exit
fi
tar -zxvf dbc-macos-client-0.3.3.1.tar.gz
