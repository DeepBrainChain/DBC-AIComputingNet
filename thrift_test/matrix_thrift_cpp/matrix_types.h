...
class show_req : public virtual ::apache::thrift::TBase {
 public:
...
class show_resp : public virtual ::apache::thrift::TBase {
 public:
...
class service_broadcast_req : public virtual ::apache::thrift::TBase {
 public:
