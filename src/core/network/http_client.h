...
namespace matrix
{
    namespace core
    {
        ...
        public:
            ...
            int32_t post(const std::string &endpoint, const kvs &headers, rapidjson::StringBuffer & req_content, http_reply &resp);

            int32_t get(const std::string &endpoint, const kvs &headers, http_reply &resp);

            int32_t del(const std::string &endpoint, const kvs &headers, http_reply &resp);
