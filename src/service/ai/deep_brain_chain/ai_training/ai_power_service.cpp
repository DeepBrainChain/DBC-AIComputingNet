...
namespace ai
{
    namespace dbc
    {
        ...
        ai_power_service::ai_power_service()
        ...
        int32_t ai_power_service::service_exit()
        {
            remove_timer(m_training_task_timer_id);
            return E_SUCCESS;
        }

        void ai_power_service::init_timer_invoker()
        {
            m_timer_invokers[AI_TRAINING_TASK_TIMER] = std::bind(&ai_power_service::on_training_task_timer, this, std::placeholders::_1);
        }

        int32_t ai_power_service::on_time_out(std::shared_ptr<core_timer> timer)
        {
        ...
        int32_t ai_power_service::init_db()
        {
        ...
        int32_t ai_power_service::init_timer()
        {
        ...
        int32_t ai_power_service::on_training_task_timer(std::shared_ptr<core_timer> timer)
        {
        ...
        int32_t ai_power_service::start_exec_training_task(std::shared_ptr<ai_training_task> task)
        {
            //judge retry times
        ...
        int32_t ai_power_service::check_training_task_status(std::shared_ptr<ai_training_task> task)
        {
            //judge retry times
            if (task->retry_times > AI_TRAINING_MAX_RETRY_TIMES)
            {
        ...
        int32_t ai_power_service::write_task_to_db(std::shared_ptr<ai_training_task> task)
        {
        ...
        int32_t ai_power_service::load_task_from_db()
        {
            try
            {
