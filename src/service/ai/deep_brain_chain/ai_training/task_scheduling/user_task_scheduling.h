...
namespace ai
{
    ...
    { 
        ...
        public:
            ...
            void fetch_nex_task() { m_queueing_tasks.pop_front();}
            std::shared_ptr<ai_training_task> find_task(std::string task_id);

            size_t get_user_task_size() {return m_queueing_tasks.size();}
            size_t get_total_user_task_size() { return m_training_tasks.size(); }

            std::shared_ptr<ai_training_task> get_top_task() { return m_queueing_tasks.front(); }
