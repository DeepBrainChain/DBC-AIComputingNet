...
namespace ai
{
    ...
    { 
        ...
        class idle_task_scheduling:public std::enable_shared_from_this<idle_task_scheduling>, boost::noncopyable
        {
            using get_idle_task_container_config = typename std::function<std::shared_ptr<container_config>(shared_ptr<ai_training_task>)>;

        public:
            idle_task_scheduling(std::shared_ptr<container_client> &container_client_ptr);
