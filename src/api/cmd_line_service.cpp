...
const char* character_names[] = {"task", "node", "start", "stop", "list", "clear", "show", "system", "quit", "peers",
                                 "result", "logs", "ps", "parameter", NULL};
...
//            cout << "ps:            get task status in cache" << endl;
        ...
        int32_t cmd_line_service::init(bpo::variables_map& options)
        {
            ...
            auto s = matrix::core::string_util::remove_leading_zero(
                    ver.substr(2, 2)) + "." + matrix::core::string_util::remove_leading_zero(
                    ver.substr(4, 2)) + "." + matrix::core::string_util::remove_leading_zero(
                    ver.substr(6, 2)) + "." + matrix::core::string_util::remove_leading_zero(ver.substr(8, 2));
...
//            m_invokers["task_ps"] = m_invokers["ps"];
        ...
        {
            opts.add_options()("task_id", bpo::value<std::string>(), "")("select_mode",
                                                                         bpo::value<int8_t>()->default_value(0), "")(
                    "master", bpo::value<std::string>()->default_value(""), "")("peer_nodes_list",
                                                                                bpo::value<std::vector<std::string>>(),
                                                                                "")("server_specification",
                                                                                    bpo::value<std::string>()->default_value(
                                                                                            ""), "")("server_count",
                                                                                                     bpo::value<int32_t>()->default_value(
                                                                                                             0), "")(
                    "training_engine", bpo::value<std::string>(), "")("code_dir", bpo::value<std::string>(), "")(
                    "entry_file", bpo::value<std::string>(), "")("data_dir",
                                                                 bpo::value<std::string>()->default_value(""), "")(
                    "checkpoint_dir", bpo::value<std::string>()->default_value(""), "")("hyper_parameters",
                                                                                        bpo::value<std::string>()->default_value(
                                                                                                ""), "")(
...
//                cout << "ref container_name " << vm["container_name"].as<std::string>() << endl;
        ...
        void cmd_line_service::start_training(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "start task")("config,c", bpo::value<std::string>(),
                                                           "task config file path")("base,b", bpo::value<std::string>(),
        ...
        void cmd_line_service::stop_training(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "stop task")("task,t",
                                                          bpo::value<std::string>()->default_value(m_last_task_id),
                                                          "task id")("force,f",
        ...
        void cmd_line_service::start_multi_training(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "start multi task")("config,c", bpo::value<std::string>(),
        ...
        void cmd_line_service::list_training(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "list task")("all,a", "list all task")("task,t",
                                                                                    bpo::value<std::string>()->default_value(
                                                                                            m_last_task_id),
                                                                                    "list a task");
        ...
        void cmd_line_service::get_peers(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "list peers")("active,a", "list active peers")("global,g",
                                                                                            "list global peers");
        ...
        void cmd_line_service::logs(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "get task running logs")("tail", bpo::value<std::string>(),
                                                                      "get log from tail")("head",
                                                                                           bpo::value<std::string>(),
                                                                                           "get log from head")(
                        "task,t", bpo::value<std::string>()->default_value(m_last_task_id), "task id")("flush,f",
                                                                                                       "flush log periodically, click 'q' to end");
        ...
        void cmd_line_service::ps(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "clear help")("all,a", "show all task cache state")("task,t",
                                                                                                 bpo::value<std::string>(),
                                                                                                 "show assign task cache state");
        ...
        void cmd_line_service::show(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "show service info and specific node info")("node,n",
                                                                                         bpo::value<std::string>(),
                                                                                         "print node's hardware info of indicated node id")(
                        "keys,k", bpo::value<std::vector<std::string>>(),
                        "if -n is specified, only print the value of indicated attribute.")("service,s",
                                                                                            "print nodes' service info in the network")(
                        "filter,f", bpo::value<std::vector<std::string>>(),
                        "if -s is specified, only print node matchs the filter.")("order,o", bpo::value<std::string>(),
        ...
        void cmd_line_service::result(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "download training result")("task,t",
                                                                         bpo::value<std::string>()->default_value(
                                                                                 m_last_task_id), "task id")("output,o",
                                                                                                             bpo::value<std::string>(),
        ...
        void cmd_line_service::task_clean(int argc, char* argv[])
        {
            ...
            try
            {
                opts.add_options()("help,h", "clear task; clear abnormal tasks if no option specified")("task,t",
                                                                                                        bpo::value<std::string>(),
                                                                                                        "task id")(
