...
typedef struct _node_list_lan_req_data__isset {
  _node_list_lan_req_data__isset() : rent_order(false) {}
  bool rent_order :1;
} _node_list_lan_req_data__isset;
...
class node_list_lan_req_data : public virtual ::apache::thrift::TBase {
 public:
  ...
  node_list_lan_req_data() : network_id(), additional(), wallet(), nonce(), sign(), multisig_threshold(0), session_id(), session_id_sign(), rent_order() {
  }

  virtual ~node_list_lan_req_data() noexcept;
  ...
  _node_list_lan_req_data__isset __isset;
...
class node_list_lan_req_body : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~node_list_lan_req_body() noexcept;
  std::string data;
...
class node_list_lan_req : public virtual ::apache::thrift::TMsgBase {
 public:
  ...
  virtual ~node_list_lan_req() noexcept;
...
class node_list_lan_rsp_body : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~node_list_lan_rsp_body() noexcept;
  std::string data;
...
class node_list_lan_rsp : public virtual ::apache::thrift::TMsgBase {
 public:
  ...
  virtual ~node_list_lan_rsp() noexcept;
...
typedef struct _node_create_lan_req_data__isset {
  _node_create_lan_req_data__isset() : rent_order(false) {}
  bool rent_order :1;
} _node_create_lan_req_data__isset;
...
class node_create_lan_req_data : public virtual ::apache::thrift::TBase {
 public:
  ...
  node_create_lan_req_data() : additional(), wallet(), nonce(), sign(), multisig_threshold(0), session_id(), session_id_sign(), rent_order() {
  }

  virtual ~node_create_lan_req_data() noexcept;
  std::vector<std::string>  peer_nodes_list;
  std::string additional;
  std::string wallet;
  std::string nonce;
  ...
  _node_create_lan_req_data__isset __isset;
...
class node_create_lan_req_body : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~node_create_lan_req_body() noexcept;
  std::string data;
...
class node_create_lan_req : public virtual ::apache::thrift::TMsgBase {
 public:
  ...
  virtual ~node_create_lan_req() noexcept;
...
class node_create_lan_rsp_body : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~node_create_lan_rsp_body() noexcept;
  std::string data;
...
class node_create_lan_rsp : public virtual ::apache::thrift::TMsgBase {
 public:
  ...
  virtual ~node_create_lan_rsp() noexcept;
...
typedef struct _node_delete_lan_req_data__isset {
  _node_delete_lan_req_data__isset() : rent_order(false) {}
  bool rent_order :1;
} _node_delete_lan_req_data__isset;
...
class node_delete_lan_req_data : public virtual ::apache::thrift::TBase {
 public:
  ...
  node_delete_lan_req_data() : network_id(), additional(), wallet(), nonce(), sign(), multisig_threshold(0), session_id(), session_id_sign(), rent_order() {
  }

  virtual ~node_delete_lan_req_data() noexcept;
  std::string network_id;
  std::vector<std::string>  peer_nodes_list;
  std::string additional;
  std::string wallet;
  ...
  _node_delete_lan_req_data__isset __isset;
...
class node_delete_lan_req_body : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~node_delete_lan_req_body() noexcept;
  std::string data;
...
class node_delete_lan_req : public virtual ::apache::thrift::TMsgBase {
 public:
  ...
  virtual ~node_delete_lan_req() noexcept;
...
class node_delete_lan_rsp_body : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~node_delete_lan_rsp_body() noexcept;
  std::string data;
...
class node_delete_lan_rsp : public virtual ::apache::thrift::TMsgBase {
 public:
  ...
  virtual ~node_delete_lan_rsp() noexcept;
