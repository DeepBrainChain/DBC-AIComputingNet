...
namespace dbc {
	...
	query_node_rent_orders_req_data::~query_node_rent_orders_req_data() throw() {
	}
	...
	query_node_rent_orders_req_body::~query_node_rent_orders_req_body() throw() {
	}
	...
	query_node_rent_orders_req::~query_node_rent_orders_req() throw() {
	}
	...
	query_node_rent_orders_rsp_body::~query_node_rent_orders_rsp_body() throw() {
	}
	...
	query_node_rent_orders_rsp::~query_node_rent_orders_rsp() throw() {
	}
	...
	node_free_memory_req_data::node_free_memory_req_data(const node_free_memory_req_data& other840) {
		peer_nodes_list = other840.peer_nodes_list;
		additional = other840.additional;
		wallet = other840.wallet;
		nonce = other840.nonce;
	...
	node_free_memory_req_data& node_free_memory_req_data::operator=(const node_free_memory_req_data& other841) {
		peer_nodes_list = other841.peer_nodes_list;
		additional = other841.additional;
		wallet = other841.wallet;
		nonce = other841.nonce;
	...
	node_free_memory_req_body::node_free_memory_req_body(const node_free_memory_req_body& other842) {
		data = other842.data;
	}
	node_free_memory_req_body& node_free_memory_req_body::operator=(const node_free_memory_req_body& other843) {
		data = other843.data;
		return *this;
	}
	...
	node_free_memory_req::node_free_memory_req(const node_free_memory_req& other844) {
		body = other844.body;
		__isset = other844.__isset;
	}
	node_free_memory_req& node_free_memory_req::operator=(const node_free_memory_req& other845) {
		body = other845.body;
		__isset = other845.__isset;
		return *this;
	}
	...
	node_free_memory_rsp_body::node_free_memory_rsp_body(const node_free_memory_rsp_body& other846) {
		data = other846.data;
	}
	node_free_memory_rsp_body& node_free_memory_rsp_body::operator=(const node_free_memory_rsp_body& other847) {
		data = other847.data;
		return *this;
	}
	...
	node_free_memory_rsp::node_free_memory_rsp(const node_free_memory_rsp& other848) {
		body = other848.body;
		__isset = other848.__isset;
	}
	node_free_memory_rsp& node_free_memory_rsp::operator=(const node_free_memory_rsp& other849) {
		body = other849.body;
		__isset = other849.__isset;
		return *this;
	}
				...
				if (ftype == ::apache::thrift::protocol::T_LIST) {
					{
						...
						this->service_list.resize(_size850);
						uint32_t _i854;
						for (_i854 = 0; _i854 < _size850; ++_i854)
						{
							xfer += iprot->readString(this->service_list[_i854]);
						}
						xfer += iprot->readListEnd();
					}
				...
				if (ftype == ::apache::thrift::protocol::T_MAP) {
					{
						...
						{
							std::string _key860;
							xfer += iprot->readString(_key860);
							std::string& _val861 = this->kvs[_key860];
							xfer += iprot->readString(_val861);
						}
	...
	uint32_t node_service_info::write(::apache::thrift::protocol::TProtocol* oprot) const {
		...
		xfer += oprot->writeFieldBegin("service_list", ::apache::thrift::protocol::T_LIST, 1);
		{
			...
			for (_iter862 = this->service_list.begin(); _iter862 != this->service_list.end(); ++_iter862)
			{
		...
		if (this->__isset.kvs) {
			xfer += oprot->writeFieldBegin("kvs", ::apache::thrift::protocol::T_MAP, 4);
			{
				...
				std::map<std::string, std::string> ::const_iterator _iter863;
				for (_iter863 = this->kvs.begin(); _iter863 != this->kvs.end(); ++_iter863)
				{
					xfer += oprot->writeString(_iter863->first);
					xfer += oprot->writeString(_iter863->second);
				}
	...
	node_service_info::node_service_info(const node_service_info& other864) {
		service_list = other864.service_list;
		name = other864.name;
		time_stamp = other864.time_stamp;
		kvs = other864.kvs;
		__isset = other864.__isset;
	}
	node_service_info& node_service_info::operator=(const node_service_info& other865) {
		service_list = other865.service_list;
		name = other865.name;
		time_stamp = other865.time_stamp;
		kvs = other865.kvs;
				...
				if (ftype == ::apache::thrift::protocol::T_MAP) {
					{
						...
						for (_i870 = 0; _i870 < _size866; ++_i870)
						{
							...
							node_service_info& _val872 = this->node_service_info_map[_key871];
	...
	uint32_t service_broadcast_req_body::write(::apache::thrift::protocol::TProtocol* oprot) const {
		...
		xfer += oprot->writeFieldBegin("node_service_info_map", ::apache::thrift::protocol::T_MAP, 1);
		{
			...
			std::map<std::string, node_service_info> ::const_iterator _iter873;
			for (_iter873 = this->node_service_info_map.begin(); _iter873 != this->node_service_info_map.end(); ++_iter873)
			{
				xfer += oprot->writeString(_iter873->first);
	...
	service_broadcast_req_body::service_broadcast_req_body(const service_broadcast_req_body& other874) {
		node_service_info_map = other874.node_service_info_map;
	}
	service_broadcast_req_body& service_broadcast_req_body::operator=(const service_broadcast_req_body& other875) {
		node_service_info_map = other875.node_service_info_map;
		return *this;
	}
	...
	service_broadcast_req::service_broadcast_req(const service_broadcast_req& other876) {
		body = other876.body;
		__isset = other876.__isset;
	}
	service_broadcast_req& service_broadcast_req::operator=(const service_broadcast_req& other877) {
		body = other877.body;
	...
	ver_req_body::ver_req_body(const ver_req_body& other878) {
		node_id = other878.node_id;
		core_version = other878.core_version;
		protocol_version = other878.protocol_version;
		time_stamp = other878.time_stamp;
		addr_me = other878.addr_me;
		addr_you = other878.addr_you;
		start_height = other878.start_height;
	}
	ver_req_body& ver_req_body::operator=(const ver_req_body& other879) {
		node_id = other879.node_id;
		core_version = other879.core_version;
		protocol_version = other879.protocol_version;
		time_stamp = other879.time_stamp;
		addr_me = other879.addr_me;
		addr_you = other879.addr_you;
		start_height = other879.start_height;
		return *this;
	}
	...
	ver_req::ver_req(const ver_req& other880) {
		body = other880.body;
		__isset = other880.__isset;
	}
	ver_req& ver_req::operator=(const ver_req& other881) {
		body = other881.body;
	...
	ver_resp_body::ver_resp_body(const ver_resp_body& other882) {
		node_id = other882.node_id;
		core_version = other882.core_version;
		protocol_version = other882.protocol_version;
	}
	ver_resp_body& ver_resp_body::operator=(const ver_resp_body& other883) {
		node_id = other883.node_id;
		core_version = other883.core_version;
		protocol_version = other883.protocol_version;
		return *this;
	}
	...
	ver_resp::ver_resp(const ver_resp& other884) {
		body = other884.body;
		__isset = other884.__isset;
	}
	ver_resp& ver_resp::operator=(const ver_resp& other885) {
		body = other885.body;
				...
				if (ftype == ::apache::thrift::protocol::T_LIST) {
					{
						...
						this->service_list.resize(_size886);
						uint32_t _i890;
						for (_i890 = 0; _i890 < _size886; ++_i890)
						{
							xfer += iprot->readString(this->service_list[_i890]);
						}
						xfer += iprot->readListEnd();
					}
	...
	uint32_t peer_node_info::write(::apache::thrift::protocol::TProtocol* oprot) const {
		...
		if (this->__isset.service_list) {
			xfer += oprot->writeFieldBegin("service_list", ::apache::thrift::protocol::T_LIST, 6);
			{
				...
				for (_iter891 = this->service_list.begin(); _iter891 != this->service_list.end(); ++_iter891)
				{
	...
	peer_node_info::peer_node_info(const peer_node_info& other892) {
		peer_node_id = other892.peer_node_id;
		core_version = other892.core_version;
		protocol_version = other892.protocol_version;
		live_time_stamp = other892.live_time_stamp;
		addr = other892.addr;
		service_list = other892.service_list;
		__isset = other892.__isset;
	}
	peer_node_info& peer_node_info::operator=(const peer_node_info& other893) {
		peer_node_id = other893.peer_node_id;
		core_version = other893.core_version;
		protocol_version = other893.protocol_version;
		live_time_stamp = other893.live_time_stamp;
		addr = other893.addr;
	...
	get_peer_nodes_req::get_peer_nodes_req(const get_peer_nodes_req& other894) {
		body = other894.body;
		__isset = other894.__isset;
	}
	get_peer_nodes_req& get_peer_nodes_req::operator=(const get_peer_nodes_req& other895) {
		body = other895.body;
				...
				if (ftype == ::apache::thrift::protocol::T_LIST) {
					{
						...
						this->peer_nodes_list.resize(_size896);
						uint32_t _i900;
						for (_i900 = 0; _i900 < _size896; ++_i900)
						{
							xfer += this->peer_nodes_list[_i900].read(iprot);
						}
						xfer += iprot->readListEnd();
					}
					isset_peer_nodes_list = true;
	...
	uint32_t get_peer_nodes_resp_body::write(::apache::thrift::protocol::TProtocol* oprot) const {
		...
		xfer += oprot->writeFieldBegin("peer_nodes_list", ::apache::thrift::protocol::T_LIST, 1);
		{
			...
			std::vector<peer_node_info> ::const_iterator _iter901;
			for (_iter901 = this->peer_nodes_list.begin(); _iter901 != this->peer_nodes_list.end(); ++_iter901)
			{
	...
	get_peer_nodes_resp_body::get_peer_nodes_resp_body(const get_peer_nodes_resp_body& other902) {
		peer_nodes_list = other902.peer_nodes_list;
	}
	get_peer_nodes_resp_body& get_peer_nodes_resp_body::operator=(const get_peer_nodes_resp_body& other903) {
		peer_nodes_list = other903.peer_nodes_list;
		return *this;
	}
	...
	get_peer_nodes_resp::get_peer_nodes_resp(const get_peer_nodes_resp& other904) {
		body = other904.body;
		__isset = other904.__isset;
	}
	get_peer_nodes_resp& get_peer_nodes_resp::operator=(const get_peer_nodes_resp& other905) {
		body = other905.body;
				...
				if (ftype == ::apache::thrift::protocol::T_LIST) {
					{
						...
						this->peer_nodes_list.resize(_size906);
						uint32_t _i910;
						for (_i910 = 0; _i910 < _size906; ++_i910)
						{
							xfer += this->peer_nodes_list[_i910].read(iprot);
						}
						xfer += iprot->readListEnd();
					}
					isset_peer_nodes_list = true;
	...
	uint32_t peer_nodes_broadcast_req_body::write(::apache::thrift::protocol::TProtocol* oprot) const {
		...
		{
			xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->peer_nodes_list.size()));
			std::vector<peer_node_info> ::const_iterator _iter911;
			for (_iter911 = this->peer_nodes_list.begin(); _iter911 != this->peer_nodes_list.end(); ++_iter911)
			{
	...
	peer_nodes_broadcast_req_body::peer_nodes_broadcast_req_body(const peer_nodes_broadcast_req_body& other912) {
		peer_nodes_list = other912.peer_nodes_list;
	}
	peer_nodes_broadcast_req_body& peer_nodes_broadcast_req_body::operator=(const peer_nodes_broadcast_req_body& other913) {
		peer_nodes_list = other913.peer_nodes_list;
		return *this;
	}
	...
	peer_nodes_broadcast_req::peer_nodes_broadcast_req(const peer_nodes_broadcast_req& other914) {
		body = other914.body;
		__isset = other914.__isset;
	}
	peer_nodes_broadcast_req& peer_nodes_broadcast_req::operator=(const peer_nodes_broadcast_req& other915) {
		body = other915.body;
	...
	node_list_monitor_server_req_data::node_list_monitor_server_req_data(const node_list_monitor_server_req_data& other934) {
	...
	node_list_monitor_server_req_data& node_list_monitor_server_req_data::operator=(const node_list_monitor_server_req_data& other935) {
	...
	node_list_monitor_server_req_body::node_list_monitor_server_req_body(const node_list_monitor_server_req_body& other936) {
		data = other936.data;
	}
	node_list_monitor_server_req_body& node_list_monitor_server_req_body::operator=(const node_list_monitor_server_req_body& other937) {
		data = other937.data;
		return *this;
	}
	...
	node_list_monitor_server_req::node_list_monitor_server_req(const node_list_monitor_server_req& other938) {
		body = other938.body;
		__isset = other938.__isset;
	}
	node_list_monitor_server_req& node_list_monitor_server_req::operator=(const node_list_monitor_server_req& other939) {
		body = other939.body;
	...
	node_list_monitor_server_rsp_body::node_list_monitor_server_rsp_body(const node_list_monitor_server_rsp_body& other940) {
		data = other940.data;
	}
	node_list_monitor_server_rsp_body& node_list_monitor_server_rsp_body::operator=(const node_list_monitor_server_rsp_body& other941) {
		data = other941.data;
		return *this;
	}
	...
	node_list_monitor_server_rsp::node_list_monitor_server_rsp(const node_list_monitor_server_rsp& other942) {
		body = other942.body;
		__isset = other942.__isset;
	}
	node_list_monitor_server_rsp& node_list_monitor_server_rsp::operator=(const node_list_monitor_server_rsp& other943) {
		body = other943.body;
	...
	node_set_monitor_server_req_data::node_set_monitor_server_req_data(const node_set_monitor_server_req_data& other962) {
	...
	node_set_monitor_server_req_data& node_set_monitor_server_req_data::operator=(const node_set_monitor_server_req_data& other963) {
	...
	node_set_monitor_server_req_body::node_set_monitor_server_req_body(const node_set_monitor_server_req_body& other964) {
		data = other964.data;
	}
	node_set_monitor_server_req_body& node_set_monitor_server_req_body::operator=(const node_set_monitor_server_req_body& other965) {
		data = other965.data;
		return *this;
	}
	...
	node_set_monitor_server_req::node_set_monitor_server_req(const node_set_monitor_server_req& other966) {
		body = other966.body;
		__isset = other966.__isset;
	}
	node_set_monitor_server_req& node_set_monitor_server_req::operator=(const node_set_monitor_server_req& other967) {
		body = other967.body;
	...
	node_set_monitor_server_rsp_body::node_set_monitor_server_rsp_body(const node_set_monitor_server_rsp_body& other968) {
		data = other968.data;
	}
	node_set_monitor_server_rsp_body& node_set_monitor_server_rsp_body::operator=(const node_set_monitor_server_rsp_body& other969) {
		data = other969.data;
		return *this;
	}
	...
	node_set_monitor_server_rsp::node_set_monitor_server_rsp(const node_set_monitor_server_rsp& other970) {
		body = other970.body;
		__isset = other970.__isset;
	}
	node_set_monitor_server_rsp& node_set_monitor_server_rsp::operator=(const node_set_monitor_server_rsp& other971) {
		body = other971.body;
	...
	node_bare_metal_bootdev_req_data::~node_bare_metal_bootdev_req_data() throw() {
	}
	...
	node_bare_metal_bootdev_req_data::node_bare_metal_bootdev_req_data(const node_bare_metal_bootdev_req_data& other1102) {
	...
	node_bare_metal_bootdev_req_data& node_bare_metal_bootdev_req_data::operator=(const node_bare_metal_bootdev_req_data& other1103) {
	...
	node_bare_metal_bootdev_req_body::~node_bare_metal_bootdev_req_body() throw() {
	}
	...
	node_bare_metal_bootdev_req_body::node_bare_metal_bootdev_req_body(const node_bare_metal_bootdev_req_body& other1104) {
		data = other1104.data;
	}
	node_bare_metal_bootdev_req_body& node_bare_metal_bootdev_req_body::operator=(const node_bare_metal_bootdev_req_body& other1105) {
		data = other1105.data;
		return *this;
	}
	...
	node_bare_metal_bootdev_req::~node_bare_metal_bootdev_req() throw() {
	}
	...
	node_bare_metal_bootdev_req::node_bare_metal_bootdev_req(const node_bare_metal_bootdev_req& other1106) {
		body = other1106.body;
		__isset = other1106.__isset;
	}
	node_bare_metal_bootdev_req& node_bare_metal_bootdev_req::operator=(const node_bare_metal_bootdev_req& other1107) {
		body = other1107.body;
	...
	node_bare_metal_bootdev_rsp_body::~node_bare_metal_bootdev_rsp_body() throw() {
	}
	...
	node_bare_metal_bootdev_rsp_body::node_bare_metal_bootdev_rsp_body(const node_bare_metal_bootdev_rsp_body& other1108) {
		data = other1108.data;
	}
	node_bare_metal_bootdev_rsp_body& node_bare_metal_bootdev_rsp_body::operator=(const node_bare_metal_bootdev_rsp_body& other1109) {
		data = other1109.data;
		return *this;
	}
	...
	node_bare_metal_bootdev_rsp::~node_bare_metal_bootdev_rsp() throw() {
	}
	...
	node_bare_metal_bootdev_rsp::node_bare_metal_bootdev_rsp(const node_bare_metal_bootdev_rsp& other1110) {
		body = other1110.body;
		__isset = other1110.__isset;
	}
	node_bare_metal_bootdev_rsp& node_bare_metal_bootdev_rsp::operator=(const node_bare_metal_bootdev_rsp& other1111) {
		body = other1111.body;
