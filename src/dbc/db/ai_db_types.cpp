...
namespace ai {
    namespace dbc {
        ...
        void ai_training_task::printTo(std::ostream &out) const {
            ...
            out << ", " << "gpus=";
            (__isset.gpus ? (out << to_string(gpus)) : (out << "<null>"));
        ...
        void cmd_task_info::printTo(std::ostream &out) const {
            ...
            out << ", " << "peer_nodes_list=";
            (__isset.peer_nodes_list ? (out << to_string(peer_nodes_list)) : (out << "<null>"));
            out << ", " << "addr=";
            (__isset.addr ? (out << to_string(addr)) : (out << "<null>"));
            out << ", " << "pwd=";
            (__isset.pwd ? (out << to_string(pwd)) : (out << "<null>"));
            out << ", " << "raw=";
            (__isset.raw ? (out << to_string(raw)) : (out << "<null>"));
            out << ")";
        }
