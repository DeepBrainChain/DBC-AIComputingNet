...
db_task_info::~db_task_info() noexcept {}
...
void db_task_info::__set_wallet(const std::string& val) {
    this->wallet = val;
    __isset.wallet = true;
}
...
uint32_t db_task_info::write(
    ...
    if (this->__isset.operation_system) {
        xfer += oprot->writeFieldBegin(
            "operation_system", ::apache::thrift::protocol::T_STRING, 14);
        xfer += oprot->writeString(this->operation_system);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.bios_mode) {
        xfer += oprot->writeFieldBegin(
            "bios_mode", ::apache::thrift::protocol::T_STRING, 15);
        xfer += oprot->writeString(this->bios_mode);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.rdp_port) {
        xfer += oprot->writeFieldBegin(
            "rdp_port", ::apache::thrift::protocol::T_STRING, 16);
        xfer += oprot->writeString(this->rdp_port);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.custom_port) {
        xfer += oprot->writeFieldBegin("custom_port",
                                       ::apache::thrift::protocol::T_LIST, 17);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->custom_port.size()));
            std::vector<std::string>::const_iterator _iter15;
            for (_iter15 = this->custom_port.begin();
                 _iter15 != this->custom_port.end(); ++_iter15) {
    ...
    if (this->__isset.multicast) {
        xfer += oprot->writeFieldBegin("multicast",
                                       ::apache::thrift::protocol::T_LIST, 18);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->multicast.size()));
            std::vector<std::string>::const_iterator _iter16;
            for (_iter16 = this->multicast.begin();
                 _iter16 != this->multicast.end(); ++_iter16) {
    ...
    if (this->__isset.desc) {
        xfer += oprot->writeFieldBegin(
            "desc", ::apache::thrift::protocol::T_STRING, 21);
        xfer += oprot->writeString(this->desc);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.vda_rootbackfile) {
        xfer += oprot->writeFieldBegin(
            "vda_rootbackfile", ::apache::thrift::protocol::T_STRING, 22);
        xfer += oprot->writeString(this->vda_rootbackfile);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.network_name) {
        xfer += oprot->writeFieldBegin(
            "network_name", ::apache::thrift::protocol::T_STRING, 24);
        xfer += oprot->writeString(this->network_name);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.public_ip) {
        xfer += oprot->writeFieldBegin(
            "public_ip", ::apache::thrift::protocol::T_STRING, 30);
        xfer += oprot->writeString(this->public_ip);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.nwfilter) {
        xfer += oprot->writeFieldBegin("nwfilter",
                                       ::apache::thrift::protocol::T_LIST, 31);
        {
            xfer += oprot->writeListBegin(
                ::apache::thrift::protocol::T_STRING,
                static_cast<uint32_t>(this->nwfilter.size()));
            std::vector<std::string>::const_iterator _iter17;
            for (_iter17 = this->nwfilter.begin();
                 _iter17 != this->nwfilter.end(); ++_iter17) {
    ...
    if (this->__isset.login_username) {
        xfer += oprot->writeFieldBegin(
            "login_username", ::apache::thrift::protocol::T_STRING, 35);
        xfer += oprot->writeString(this->login_username);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.delete_time) {
        xfer += oprot->writeFieldBegin("delete_time",
    ...
    if (this->__isset.interface_model_type) {
        xfer += oprot->writeFieldBegin(
            "interface_model_type", ::apache::thrift::protocol::T_STRING, 40);
        xfer += oprot->writeString(this->interface_model_type);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.order_id) {
        xfer += oprot->writeFieldBegin(
            "order_id", ::apache::thrift::protocol::T_STRING, 41);
        xfer += oprot->writeString(this->order_id);
        xfer += oprot->writeFieldEnd();
    }
    if (this->__isset.wallet) {
        xfer += oprot->writeFieldBegin(
            "wallet", ::apache::thrift::protocol::T_STRING, 42);
...
void db_task_info::printTo(std::ostream& out) const {
    ...
    out << ", "
        << "image_name=";
    (__isset.image_name ? (out << to_string(image_name)) : (out << "<null>"));
    out << ", "
        << "login_password=";
    (__isset.login_password ? (out << to_string(login_password))
                            : (out << "<null>"));
    out << ", "
        << "ssh_port=";
    (__isset.ssh_port ? (out << to_string(ssh_port)) : (out << "<null>"));
    out << ", "
        << "create_time=";
    (__isset.create_time ? (out << to_string(create_time)) : (out << "<null>"));
    out << ", "
        << "operation_system=";
    (__isset.operation_system ? (out << to_string(operation_system))
                              : (out << "<null>"));
    out << ", "
        << "bios_mode=";
    (__isset.bios_mode ? (out << to_string(bios_mode)) : (out << "<null>"));
    out << ", "
        << "rdp_port=";
    (__isset.rdp_port ? (out << to_string(rdp_port)) : (out << "<null>"));
    out << ", "
        << "custom_port=";
    (__isset.custom_port ? (out << to_string(custom_port)) : (out << "<null>"));
    out << ", "
        << "multicast=";
    (__isset.multicast ? (out << to_string(multicast)) : (out << "<null>"));
    out << ", "
        << "desc=";
    (__isset.desc ? (out << to_string(desc)) : (out << "<null>"));
    out << ", "
        << "vda_rootbackfile=";
    (__isset.vda_rootbackfile ? (out << to_string(vda_rootbackfile))
                              : (out << "<null>"));
    out << ", "
        << "network_name=";
    (__isset.network_name ? (out << to_string(network_name))
                          : (out << "<null>"));
    out << ", "
        << "public_ip=";
    (__isset.public_ip ? (out << to_string(public_ip)) : (out << "<null>"));
    out << ", "
        << "nwfilter=";
    (__isset.nwfilter ? (out << to_string(nwfilter)) : (out << "<null>"));
    out << ", "
        << "login_username=";
    (__isset.login_username ? (out << to_string(login_username))
                            : (out << "<null>"));
    out << ", "
        << "delete_time=";
    (__isset.delete_time ? (out << to_string(delete_time)) : (out << "<null>"));
    out << ", "
        << "interface_model_type=";
    (__isset.interface_model_type ? (out << to_string(interface_model_type))
                                  : (out << "<null>"));
    out << ", "
        << "order_id=";
    (__isset.order_id ? (out << to_string(order_id)) : (out << "<null>"));
    out << ", "
        << "wallet=";
    (__isset.wallet ? (out << to_string(wallet)) : (out << "<null>"));
    out << ")";
}
