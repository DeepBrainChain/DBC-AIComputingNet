...
typedef struct _db_task_info__isset {
    _db_task_info__isset()
        : image_name(false),
          ...
          multicast(false),
          desc(false),
          vda_rootbackfile(false),
          network_name(false),
          public_ip(false),
          nwfilter(false),
          login_username(false),
          delete_time(false),
          interface_model_type(false),
          order_id(false),
          wallet(false) {}
    bool image_name : 1;
...
public:
    ...
    bool operator==(const db_task_info& rhs) const {
        ...
        if (__isset.login_password != rhs.__isset.login_password)
            return false;
        else if (__isset.login_password &&
                 !(login_password == rhs.login_password))
            return false;
        ...
        if (__isset.operation_system != rhs.__isset.operation_system)
            return false;
        else if (__isset.operation_system &&
                 !(operation_system == rhs.operation_system))
            return false;
        ...
        if (__isset.vda_rootbackfile != rhs.__isset.vda_rootbackfile)
            return false;
        else if (__isset.vda_rootbackfile &&
                 !(vda_rootbackfile == rhs.vda_rootbackfile))
            return false;
        ...
        if (__isset.login_username != rhs.__isset.login_username)
            return false;
        else if (__isset.login_username &&
                 !(login_username == rhs.login_username))
            return false;
        if (__isset.delete_time != rhs.__isset.delete_time)
            return false;
        else if (__isset.delete_time && !(delete_time == rhs.delete_time))
            return false;
        if (__isset.interface_model_type != rhs.__isset.interface_model_type)
            return false;
        else if (__isset.interface_model_type &&
                 !(interface_model_type == rhs.interface_model_type))
            return false;
        if (__isset.order_id != rhs.__isset.order_id)
            return false;
        else if (__isset.order_id && !(order_id == rhs.order_id))
            return false;
        if (__isset.wallet != rhs.__isset.wallet)
            return false;
        else if (__isset.wallet && !(wallet == rhs.wallet))
            return false;
        return true;
    }
    bool operator!=(const db_task_info& rhs) const { return !(*this == rhs); }
