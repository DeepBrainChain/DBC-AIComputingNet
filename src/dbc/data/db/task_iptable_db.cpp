...
void TaskIptableDB::load_iptables(std::map<std::string, std::shared_ptr<dbc::task_iptable>>& task_iptables)
{
...
std::shared_ptr<dbc::task_iptable> TaskIptableDB::read_iptable(const std::string& task_id) {
    if (task_id.empty())
        return nullptr;
...
bool TaskIptableDB::write_iptable(const std::shared_ptr<dbc::task_iptable>& task_iptable)
{
