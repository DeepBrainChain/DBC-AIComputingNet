...
namespace matrix {
    namespace service_core {
        ...
        void p2p_net_service::init_subscription() {
            ...
            TOPIC_MANAGER->subscribe(typeid(matrix::service_core::cmd_get_peer_nodes_req).name(),
                                     [this](std::shared_ptr<dbc::network::message> &msg) { return send(msg); });
        ...
        int32_t p2p_net_service::on_ver_resp(std::shared_ptr<dbc::network::message> &msg) {
            std::shared_ptr<matrix::service_core::ver_resp> resp_content = std::dynamic_pointer_cast<matrix::service_core::ver_resp>(
                    msg->content);
            if (!resp_content) {
        ...
        int32_t p2p_net_service::on_get_peer_nodes_resp(std::shared_ptr<dbc::network::message> &msg) {
            ...
            std::shared_ptr<matrix::service_core::get_peer_nodes_resp> rsp = std::dynamic_pointer_cast<matrix::service_core::get_peer_nodes_resp>(
                    msg->content);
            if (!rsp) {
