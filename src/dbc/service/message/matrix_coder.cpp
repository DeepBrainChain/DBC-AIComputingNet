...
//                        msg->set_name(content->header.msg_name);
        ...
        decode_status
        matrix_coder::decode_frame(channel_handler_context &ctx, byte_buf &in, std::shared_ptr<message> &msg) {
        ...
        decode_status
        matrix_coder::decode_service_frame(channel_handler_context &ctx, byte_buf &in, std::shared_ptr<message> &msg,
        ...
        void matrix_coder::decode_invoke(std::shared_ptr<message> &msg, base_header &header,
                                         std::shared_ptr<protocol> &proto) {
        ...
        encode_status matrix_coder::encode(channel_handler_context &ctx, message &msg, byte_buf &out) {
            ...
            try {
                ...
                // encode
                std::shared_ptr<matrix::core::msg_forward> bin_fwd_content = std::dynamic_pointer_cast<matrix::core::msg_forward>(
                        msg.content);
                if (bin_fwd_content) {
        ...
        template<typename msg_type>
        void matrix_coder::encode_invoke(channel_handler_context &ctx, std::shared_ptr<protocol> &proto, message &msg,
                                         byte_buf &out) {
