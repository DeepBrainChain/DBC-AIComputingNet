...
namespace service
{
    namespace misc
    {
        ...
        protected:
            ...
            int32_t on_get_task_queue_size_resp(std::shared_ptr<message> &msg);

        private:
            int32_t on_cli_show_req(std::shared_ptr<message> &msg);
            int32_t on_net_show_req(std::shared_ptr<message> &msg);
            int32_t on_net_show_resp(std::shared_ptr<message> &msg);
