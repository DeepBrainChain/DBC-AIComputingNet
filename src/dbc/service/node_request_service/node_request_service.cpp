...
void node_request_service::init_invoker() {
    ...
    BIND_MESSAGE_INVOKER(NODE_LIST_LAN_REQ, &node_request_service::on_node_list_lan_req)
    // BIND_MESSAGE_INVOKER(NODE_CREATE_LAN_REQ, &node_request_service::on_node_create_lan_req)
    BIND_MESSAGE_INVOKER(NODE_DELETE_LAN_REQ, &node_request_service::on_node_delete_lan_req)
}
...
void node_request_service::init_subscription() {
    ...
    SUBSCRIBE_BUS_MESSAGE(NODE_LIST_LAN_REQ);
    // SUBSCRIBE_BUS_MESSAGE(NODE_CREATE_LAN_REQ);
    SUBSCRIBE_BUS_MESSAGE(NODE_DELETE_LAN_REQ);
}
