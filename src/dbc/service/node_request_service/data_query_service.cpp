...
namespace dbc
{
    ...
    int32_t data_query_service::on_timer_node_info_collection(const std::shared_ptr<matrix::core::core_timer>& timer) {
    ...
    std::shared_ptr<dbc::network::message> data_query_service::create_node_query_node_info_req_msg(const std::shared_ptr<::cmd_list_node_req> &cmd_req) {
        auto req_content = std::make_shared<matrix::service_core::node_query_node_info_req>();
        // header
    ...
    int32_t data_query_service::on_node_query_node_info_rsp(std::shared_ptr<dbc::network::message> &msg) {
        ...
        std::shared_ptr<matrix::service_core::node_query_node_info_rsp> rsp_content =
                std::dynamic_pointer_cast<matrix::service_core::node_query_node_info_rsp>(msg->content);
        if (!rsp_content) {
    ...
    int32_t data_query_service::on_node_query_node_info_timer(const std::shared_ptr<core_timer>& timer)
    {
        ...
        //get session
        string session_id = timer->get_session_id();
    ...
    int32_t data_query_service::on_node_query_node_info_req(std::shared_ptr<dbc::network::message> &msg) {
        ...
        std::shared_ptr<matrix::service_core::node_query_node_info_req> req =
                std::dynamic_pointer_cast<matrix::service_core::node_query_node_info_req>(msg->get_content());
        if (req == nullptr) {
    ...
    int32_t data_query_service::query_node_info(const std::shared_ptr<matrix::service_core::node_query_node_info_req> &req) {
        ...
        std::shared_ptr<matrix::service_core::node_query_node_info_rsp> rsp_content = std::make_shared<matrix::service_core::node_query_node_info_rsp>();
        // header
    ...
    std::shared_ptr<dbc::network::message> data_query_service::create_service_broadcast_req_msg(const service_info_map& mp) {
        auto req_content = std::make_shared<matrix::service_core::service_broadcast_req>();
        // header
        req_content->header.__set_magic(CONF_MANAGER->get_net_flag());
        req_content->header.__set_msg_name(SERVICE_BROADCAST_REQ);
        req_content->header.__set_nonce(dbc::create_nonce());
        req_content->header.__set_session_id(dbc::create_session_id());
        std::vector<std::string> path;
        path.push_back(CONF_MANAGER->get_node_id());
        req_content->header.__set_path(path);
        std::map<std::string, std::string> exten_info;
    ...
    int32_t data_query_service::on_timer_service_broadcast(const std::shared_ptr<matrix::core::core_timer>& timer)
    {
    ...
    int32_t data_query_service::on_net_service_broadcast_req(std::shared_ptr<dbc::network::message> &msg) {
        ...
        std::shared_ptr<matrix::service_core::service_broadcast_req> req =
                std::dynamic_pointer_cast<matrix::service_core::service_broadcast_req>(msg->get_content());
        if (req == nullptr) {
            LOG_ERROR << "req is nullptr";
            return E_DEFAULT;
        }
