...
namespace dbc {
    ...
    typedef struct _TaskInfo__isset {
        _TaskInfo__isset() : login_password(false), ssh_port(false), status(false), operation(false), create_time(false), last_start_time(false), last_stop_time(false), hardware_resource(false), vm_xml(false), vm_xml_url(false) {}
