...
static void cmd_line_task() {
    static dbc::cmd_line_service *service = (dbc::cmd_line_service *) (g_server->get_module_manager()->get(
...
namespace dbc {
    ...
    static void print_cmd_task_usage() {
        cout << "start:         start a new task" << endl;
        cout << "stop:          stop a existing task" << endl;
        cout << "restart:       restart a existing task" << endl;
    ...
    void cmd_line_service::init_cmd_invoker() {
        ...
        m_invokers["clear"] = std::bind(&cmd_line_service::clear, this, std::placeholders::_1,
                                        std::placeholders::_2);
        m_invokers["history"] = std::bind(&cmd_line_service::history, this, std::placeholders::_1,
                                          std::placeholders::_2);
        ...
        m_invokers["reboot"] = std::bind(&cmd_line_service::node_reboot, this, std::placeholders::_1,
                                         std::placeholders::_2);

        m_invokers["task_restart"] = std::bind(&cmd_line_service::task_restart, this, std::placeholders::_1,
                                               std::placeholders::_2);

#ifndef WIN32
        m_invokers["key"] = std::bind(&cmd_line_service::cmd_key, this, std::placeholders::_1,
                                      std::placeholders::_2);
#endif
    ...
    void cmd_line_service::start_training(int argc, char *argv[]) {
        ...
        try {
            opts.add_options()
                    ...
                    ("description,d", bpo::value<std::string>(),
                     "task description, help to identify the task purpose")
