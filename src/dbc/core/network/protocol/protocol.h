...
namespace dbc
{
    namespace network
    {
        ...
        {
            if (matrix::core::env_manager::get_endian_type() == matrix::core::little_endian)
            {
                return (((unsigned long long)htonl((int)((val << 32) >> 32))) << 32) | (unsigned int)htonl((int)(val >> 32));
            }
            else if (matrix::core::env_manager::get_endian_type() == matrix::core::big_endian)
            {
                return val;
            }
            else
        ...
        public:
            ...
            virtual void init_buf(matrix::core::byte_buf *buf) = 0;

            virtual matrix::core::byte_buf* get_buf() = 0;
