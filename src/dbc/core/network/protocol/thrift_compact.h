...
namespace dbc
{
    namespace network
    {
        ...
        public:
            ...
            compact_protocol( matrix::core::byte_buf *buf,
            ...
            void init_buf(matrix::core::byte_buf *buf) { m_buf = buf; }

            matrix::core::byte_buf* get_buf() { return m_buf; }
